// Ported verbatim from the proven member-portal design system (2.25: the
// sanctioned design source). All durations, easings, and springs live here —
// components never define motion values inline.
